...
namespace Dolstagis.Web.Static
{
    public class MimeTypes : Dolstagis.Web.Static.IMimeTypes
    {
        ...
        // First, it's out of date and incomplete already.
        // Second, it introduces a dependency on System.Web, which I don't want to do.
        ...
        public string GetMimeType(string filename)
        {
            ...
            if (extension.Success) {
                string mime;
                return _mappings.TryGetValue(extension.Value, out mime) ? mime : DefaultMimeType;
            }
            else {
